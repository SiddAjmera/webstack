...
export class SpeakersComponent implements OnInit {
  ...
  speakers = [
    {
      ...
      image:
        "https://scontent.fpnq2-1.fna.fbcdn.net/v/t1.0-9/35426833_1654903297897980_4957177869231980544_n.jpg?_nc_cat=111&_nc_ht=scontent.fpnq2-1.fna&oh=d17e6d51e9336ad48da5aaaa4d47338f&oe=5CD24DEF",
      // companyLogo: 'https://www.tcs.com/content/dam/tcs/images/logo/tcs50-white1.png',
      details:
        "Siddharth is a Google Developer Expert for Angular and a Full Stack JavaScript Developer with immense love and passion for the JavaScript(especially Angular) developer community.",
    ...
    },
    {
      ...
      image:
        "https://pbs.twimg.com/profile_images/1024004701065338882/Qs4GJJpC_400x400.jpg",
      companyLogo:
        "https://labs.synerzip.com/wp-content/themes/synerzip/beta_images/header-black-logo.png",
      details:
        "Pankaj is a three-time Microsoft MVP and a Team Lead at Synerzip. He's an Angular Enthusiast with around 6 years of experience in the industry. He's also an OpenSource Contributor and an OSS Lover.",
    ...
    },
    {
      ...
      // companyLogo: 'https://www.tcs.com/content/dam/tcs/images/logo/tcs50-white1.png',
      details:
        "Akshay is a JavaScript junkie and loves writing Apps that run on Web, Mobile, and Voice channels, to deliver Omnichannel experiences.",
      facebook: "",
    ...
    },
    {
      ...
      image:
        "https://scontent.fpnq2-1.fna.fbcdn.net/v/t1.0-9/27750647_1609902509057835_604483265165669179_n.jpg?_nc_cat=109&_nc_ht=scontent.fpnq2-1.fna&oh=76b18049eb616ecbf5df6a68536571b4&oe=5CC952D5",
      // image: 'assets/images/speakers/speaker7.jpg',
      // companyLogo: 'https://www.tcs.com/content/dam/tcs/images/logo/tcs50-white1.png',
      details:
        "Jagdeep works as a Solution Architect at TCS. Apart from being an occasional poet and a random traveler, he's also into hiking, marathons, and software development.",
  ...
  ngOnInit() {
    this.speakers$ = this.dataService.getSpeakersList();
  }
}
