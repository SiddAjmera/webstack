  ...
  speakers = [
    {
      ...
      details: 'Siddharth is a Google Developer Expert for Angular and a Full Stack JavaScript Developer with immense love and passion for the JavaScript(especially Angular) developer community.',
    ...
    },
    {
      ...
      // companyLogo: 'https://www.tcs.com/content/dam/tcs/images/logo/tcs50-white1.png',
      details: 'Jagdeep works as a Solution Architect at TCS. Apart from being an occasional poet and a random traveler, he\'s also into hiking, marathons, and software development.',
